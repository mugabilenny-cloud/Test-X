...
def fetch_feed(department: Optional[str] = None, student_id: str = "demo-student"):
    """Return non-ad feed resources.

    Paid placements are handled separately by local_ads so the existing feed
    contract remains available for future campus/editorial content.
    """
    return []
